...
date_list=$(date +"%Y-%m-%d" -d "$data_server")
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME TO SYNCH STORE VPN ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
echo -e " PROSES PENGECEKAN IP ADDRESS ANDA !!"
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green}SYNCH STORE® ${NC}${YELLOW}(${NC}${green}V 3.5${NC}${YELLOW})${NC}"
echo -e " ›TEAM 🅥🅝: SYNCH STORE ${YELLOW}(${NC} 2025 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/G-Force-X/vpn/refs/heads/main/"
...
clear
izinsc="https://raw.githubusercontent.com/G-Force-X/ijin/refs/heads/main/alpha"
# USERNAME
rm -f /usr/bin/user
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://synch.id/"}]]}' 
...
bash -c "$(curl -L https://github.com/XTLS/Xray-install/raw/main/install-release.sh)" @ install -u www-data --version $latest_version
    ...
    sudo curl -fsSL https://raw.githubusercontent.com/G-Force-X/vpn/refs/heads/main/config/nginx.conf -o /etc/nginx/nginx.conf
...
wget -q https://raw.githubusercontent.com/G-Force-X/vpn/refs/heads/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
wget -q -O /etc/default/dropbear https://raw.githubusercontent.com/G-Force-X/vpn/refs/heads/main/config/dropbear.conf
...
wget -q https://raw.githubusercontent.com/G-Force-X/vpn/refs/heads/main/udp-custom/udp-custom.sh
...
#OpenVPN
wget https://raw.githubusercontent.com/G-Force-X/vpn/refs/heads/main/config/openvpn  chmod +x openvpn && ./openvpn
...
# Ganti Banner
wget -O /etc/kyt.txt https://raw.githubusercontent.com/G-Force-X/vpn/refs/heads/main/files/issue.net
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ SCRIPT BY SYNCH NETWORK ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
echo "Semuanya Berjalan Ok...Terimakasih Telah menggunakan Script Synch Network!!"
sleep 1
